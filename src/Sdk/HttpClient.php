...
namespace bookingtime\phpsdkmodule\Sdk;
use Nyholm\Psr7\Factory\Psr17Factory;
use Buzz\{Browser,Client\Curl};
use bookingtime\phpsdkmodule\Sdk\Exception\AuthenticationException;
use bookingtime\phpsdkmodule\Sdk\Exception\RequestException;
...
class HttpClient {
	...
	protected $client_id='';//from module
	protected $client_secret='';//from module
	...
	public function __construct($client_id,$client_secret,array &$config) {
		...
		//build url prefix
		$this->urlPrefix=$this->config['moduleApiUrl'];
	 ...
	 * @return	mixed		buzz response with message and content, or binaray content
	 */
